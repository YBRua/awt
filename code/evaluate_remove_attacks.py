...
parser.add_argument('--remove_prob', type=float, default=0.05,
...
def evaluate(data_source, out_file, batch_size=10, on_train=False):
    ...
    for i in range(0, data_source.size(0) - args.bptt, args.bptt):
        ...
        with torch.no_grad():
            ...
            best_beam_emb =  model_gen.forward_sent(best_beam_removed_idx,msgs,args.gumbel_temp,only_embedding=True)			
