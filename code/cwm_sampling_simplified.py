...
def parse_args_cwm_simplified_eval():
...
def setup_logger_cwm_simplified_eval():
    logger = logging.getLogger('Simplified Evaluation')
    ...
    filename = f'cwm-eval-simple-{timestamp}.log'
...
if __name__ == '__main__':
    args = parse_args_cwm_simplified_eval()
    main(args)
